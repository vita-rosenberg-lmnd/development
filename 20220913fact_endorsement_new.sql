...
select
    ...
    pv.end_date AS end_of_month_date,
...
CURRENT_DATE(), NULL, EFFECTIVE_DATE_FROM, EFFECTIVE_DATE_TO, 'USD', CHANGE_VALUE, VALUE, annual
from cte_first_version
where policy_version_id not in (select policy_version_id from BI_DEVELOPMENT.endorsement_fact_written)
;
