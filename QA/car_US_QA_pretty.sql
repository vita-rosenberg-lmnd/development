...
SELECT public_id,
       errType
FROM   car_not_cancelled_monthly_written_premium
UNION
SELECT public_id,
       errType
FROM   car_flat_cancelled_monthly_written_premium
UNION
SELECT public_id,
       errType
FROM   car_flat_cancelled_monthly_earned_premium
UNION
SELECT public_id,
       errType
...
SELECT public_id,
       errType
FROM   car_active_policies_monthly_written_premium
UNION
SELECT public_id,
       errType
FROM   car_active_policies_monthly_earned_premium
UNION
SELECT   public_id,
         errType
FROM     car_inactive_policies_monthly_difference
ORDER BY errType
